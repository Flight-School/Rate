...
final class RateTests: XCTestCase {
    ...
    static var allTests = [
        ...
        ("testMultiplicationByMeasurement", testMultiplicationByMeasurement),
        ("testMultiplicationByScalar", testMultiplicationByScalar),
        ("testDivisionByScalar", testDivisionByScalar)
    ]
}
